/* 
 Mini CNC Plotter firmware, based in https://github.com/adidax/mini_cnc_plotter_firmware
 ...
 This code source has been modified and adapted for the purpuse of this project by Ndongmo Fabrice & Hesham Zreik
  */
...
void drawLine(float x1, float y1) {
  ...
  if (dx > dy) {
    for (i=0; i<dx; ++i) {
      myStepperX.step(StepInc, sx, DOUBLE);
      over+=dy;
      if (over>=dx) {
        over-=dx;
        myStepperY.step(StepInc, sy, DOUBLE);
      }
      delay(StepDelay);
    }
  }
